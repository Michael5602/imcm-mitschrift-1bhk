...
- Funktionsweise: Paketvermittlung (*Packet Switching*) Nachrichten werden in kleine Pakete aufgeteilt und unabhängig verschickt.
- Internet ist das Netz der Netze besteht aus vielen kleineren Netzen unterschiedlicher Internet anbiebeter (*Internet Service Provider ISP*) Salzburg Ag, Magenta, A1
